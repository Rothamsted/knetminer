...
<ul>                       		
      <li style="float: left; width: 23%;"><a target="_blank" title="Rothamsted Research" href="http://www.rothamsted.ac.uk/" class="logos"><img src="html/image/rothamsted_logo.png" width="80" height="80"/></a>  <!--width="63.6" height="85.5"/> -->
      ...
      <li style="float: left; width: 50%; margin: 0px 2%;"><img class="knetminer-logo" src="html/image/logo-regular.png" alt="Logo" with="201.5" height="66.3">
        <p id="text-logo">Supported by BBSRC grants BB/F006039/1, BB/I023860/1, BB/N022874/1</p>  </li>
    <li style="float: left; width: 20%;"><h4><i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp;&nbsp;Contact us:</h4>
