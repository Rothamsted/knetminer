...
//                  title: 'highlighter colour', content: 'This is a modal!', cancelButton: 'Exit', draggable: 'title',
//                  attributes: { x: 'right', y: 'top' }, delayOpen: 100 });
//              
//              myModal.open();
              // Create the div
...
//              var newCol = "";
//              new Picker({
//                  parent: $('#itemInfo'), popup: false, alpha: false, color: colour, editor: false, layout: 'default',
//                  editorFormat: 'hsl', cancelButton: true, onChange: function(color){ newCol = color; }
//              });
