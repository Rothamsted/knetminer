...
function loginModalInit() {
    getKsAPI().then(function (ksAddress) {
        ...
        var loginModal = new jBox('Modal', {
            id: 'loginBox',
            animation: 'pulse',
            title: '<font size="5"><font color="white">Sign in to KnetSpace</font></font>',
            content: loginHtml,
            cancelButton: 'Exit',
            draggable: 'title',
            attributes: {
                ...
                returnJson().then(function (myJson) {
                    ...
                    $('#login_icon').click(function () {
                        ...
                        if (firstName !== "null" || typeof firstName == "object") {
                            var profileTitle = '<font size="5"><font color="white">Welcome, ' + firstName + '</font></font>';
                        } else {
                            var profileTitle = '<font size="5"><font color="white">Welcome, ' + myJson.username + '</font></font>';
                        }
