...
function generateCyJSNetwork(url,list){
	...
	$.post(url, list, function(response, textStatus){																							 
	var oxl = response.split(":")[1];
        console.log("generateCyJSNetwork>> oxl: "+ oxl);

        // Network Graph: JSON file.
        var network_json= oxl.substring(0, oxl.length()-4) +".json";
        ...
        var cyjs_network= '<html><head>'+
                ...
                '<script src="html/javascript/jquery-1.11.2.min.js"></script>'+
                '<script src="html/javascript/cytoscape.min.js"></script>'+
                '<script src="html/javascript/jquery-ui.js"></script>'+
                '<script src="html/javascript/cytoscape-cxtmenu.js"></script>'+
                ...
                '<script src="html/javascript/cola.v3.min.js"></script>'+
                '<script src="html/javascript/cola.adaptor.js"></script>'+
                '<script src="html/javascript/arbor.js"></script>'+
                '<script src="html/javascript/dagre.js"></script>'+
                '<script src="html/javascript/springy.js"></script>'+
...
function createGenesTable(tableUrl, keyword, rows){
	...
	$.ajax({
        ...
        success: function printGenesTable(text){
    		...
    		table = table + '<div id="new_networkButton"><input id="new_generateMultiGeneNetworkButton" class = "button" type = "button" value = "Open cyJS Network" title = "Display new lightweight, cytoscapeJS Network Viewer"></insert><div id="loadingNetworkDiv"></div></div>';
