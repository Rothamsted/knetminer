...
<ul>                       		
      <li style="float: left; width: 20%;"><a target="_blank" title="Rothamsted Research" href="http://www.rothamsted.ac.uk" class="logos"><img src="html/image/rothamsted_logo.png" width="63.6" height="85.5"/></a>  
      ...
      <li style="float: left; width: 52%; margin: 0px 2%;"><img class="knetminer-logo" src="html/image/logo-regular.png" alt="Logo" with="201.5" height="66.3">
        <p id="text-logo">Supported by BBSRC SABR and TRDF awards BB/F006039/1 and BB/I023860/1</p>  </li>       
      <li style="float: left;"><a target="_blank" href="html/release.html">Release Notes</a></li>      
