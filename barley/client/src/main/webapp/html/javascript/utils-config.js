var api_url = "http://knetminer.rothamsted.ac.uk/barley_data/";
...
var longest_chr = 196087864; //its needed if the first chromosome is not the longest to scale the chromosome view in gviewer
var species_name = 'Hordeum vulgare';
