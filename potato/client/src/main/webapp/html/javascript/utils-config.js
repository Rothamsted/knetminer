var api_url = "http://knetminer.rothamsted.ac.uk/potato_data/";
//var data_url = "http://qtlnetminer-test.rothamsted.ac.uk/potato_data/"; // now, using HTTP instead of HTTPS
...
var species_name = 'Solanum tuberosum';
