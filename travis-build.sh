...
#docker build -t knetminer/knetminer-base:$docker_tag -f common/docker/Dockerfile-base .

echo -e "\n\n\tBuilding Docker"
docker build -t knetminer/knetminer:$docker_tag -f common/docker/Dockerfile .
