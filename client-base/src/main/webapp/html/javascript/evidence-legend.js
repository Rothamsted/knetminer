...
function getEvidencesLegend(ev_fullText) {
    ...
    evi_legend.forEach(function (value, key, map) {
        ...
        summaryText = summaryText + '<div  onclick=filterTableByType("' + contype + '","#evidenceTable",' + 1 + ',"tablesorterEvidence",event,"revertEvidenceView");  class="evidenceSummaryItem"><div class="evidence-icons evidence_item evidence_item_' + key + '"  title="' + key+ '"></div> <span style="font-weight:600;">' + key+ '</span></div>';
    });
